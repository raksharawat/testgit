...
class StudentDriver
{
	public static void main(String args[])
	{
		...
		float cgpa;
		Scanner sc=new Scanner(System.in);       //done4
		Scanner isc=new Scanner(System.in);      //done4
		...
		pin= isc.nextInt();
		Address ad=new Address(adline1,adline2,adcity,adstate,pin);       //done2
		System.out.println("Enter date of birth in the order: date/month/year");
		date=isc.nextInt();
		month=isc.nextInt();
		year=isc.nextInt();
		Date dob=new Date(date,month,year);      //done2
